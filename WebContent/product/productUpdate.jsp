...
<html>
	...
	<body>
		...
		<form method="post" enctype="multipart/form-data" name="frm" action="">
			...
			<input type="text" name="nonmakeImg" value="${product.pictureUrl}">
			<table>
				<tr>
					<td>
						<c:choose>
					...
					<td>
						<table>
							<tr>
								...
								<td>
									<input type="text" name="name" value="${product.name}" size="50">
								</td>
							</tr>
							<tr>
								<th> 가   격 </th>
							...
							<tr>
								<th> 설  명 </th>
								<td>
									<textarea rows="10" cols="52" name="description">${product.description}</textarea>
								</td>
							</tr>
						</table>
					</td>
